                ...
                else
                {
                    ...
                    if ((!world.isOutsideBuildHeight(blockpos)) && (!world.isOutsideBuildHeight(blockpos1)) && (!world.isOutsideBuildHeight(blockpos2)) && (!world.isOutsideBuildHeight(blockpos2.add(structureboundingbox.getLength()))))
                    {
                        if (world.isAreaLoaded(structureboundingbox) && world.isAreaLoaded(structureboundingbox1))
                        {
                                    ...
                                    for (int l = structureboundingbox.minX; l <= structureboundingbox.maxX; ++l)
                                    {
                                        ...
                                        if ((!flag1 || iblockstate.getBlock() != Blocks.AIR) && (block == null || iblockstate.getBlock() == block && (predicate == null || predicate.apply(iblockstate))))
                                        {
                                            ...
                                            if (tileentity != null)
                                            {
                                                ...
                                                list1.add(new CommandExtendedClone.StaticCloneData(blockpos5, iblockstate, nbttagcompound));
                                                deque.addLast(blockpos4);
                                            }
                                            else if (!iblockstate.isFullBlock() && !iblockstate.isFullCube())
                                            {
                                                list2.add(new CommandExtendedClone.StaticCloneData(blockpos5, iblockstate, (NBTTagCompound)null));
                                                deque.addFirst(blockpos4);
                                            }
                                            else
                                            {
                                                list.add(new CommandExtendedClone.StaticCloneData(blockpos5, iblockstate, (NBTTagCompound)null));
                                                deque.addLast(blockpos4);
                                            }
                                        }
                                    }
                            ...
                            list3.addAll(list1);
                            list3.addAll(list2);
                            List<CommandExtendedClone.StaticCloneData> list4 = Lists.<CommandExtendedClone.StaticCloneData>reverse(list3);
